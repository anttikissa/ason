...
// Create a new logger with `module` as prefix
Log.prototype.as = function(module) {
	console.log(".as(), this: " + this);
	console.log(".as(), typeof this: " + typeof this);

	var self = this;
	// TODO does not inherit all the stuff, make it do that
	return function(msg) {
		self(module + " " + msg);
	}
};
